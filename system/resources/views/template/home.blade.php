                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="slider_img-box">
                        <div>
                          <img src="{{ url('public/assets') }}/images/slide-img.png" alt="" class="" />
                        </div>
                      </div>
                    </div>
                  </div>
  ...
  <section class="service_section layout_padding ">
    <div class="container">
      ...
      <div class=" layout_padding2">
        <div class="card-deck">
          <div class="card">
            <img class="card-img-top" src="{{ url('public/assets') }}/images/card-item-1.png" alt="Card image cap" />
            <div class="card-body">
          ...
          <div class="card">
            <img class="card-img-top" src="{{ url('public/assets') }}/images/card-item-2.png" alt="Card image cap" />
            <div class="card-body">
          ...
          <div class="card">
            <img class="card-img-top" src="{{ url('public/assets') }}/images/card-item-3.png" alt="Card image cap" />
            <div class="card-body">
